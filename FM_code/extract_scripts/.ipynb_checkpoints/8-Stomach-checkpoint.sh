...
for model in $models
do
        DIR_TO_COORDS=$prefix"/rawdata/Stomach_patch"
        CSV_FILE_NAME="dataset_csv/Stomach_patch.csv"
        FEATURES_DIRECTORY=$prefix"/Patches/Stomach_patch"
...
# srun -p smart_health_00 -w SH-IDC1-10-140-1-167 --gres=gpu:1 --cpus-per-task=16 --time=60:00:00 bash extract_scripts/8-Stomach.sh