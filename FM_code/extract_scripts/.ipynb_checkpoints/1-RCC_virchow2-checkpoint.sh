...
models="virchow2"
# models="resnet50 uni conch ctranspath GPFM phikon plip uni gigapath virchow2"
...
# srun -p smart_health_00 -w SH-IDC1-10-140-1-166 --gres=gpu:1 --cpus-per-task=16 --time=60:00:00 bash extract_scripts/1-RCC_virchow2.sh
