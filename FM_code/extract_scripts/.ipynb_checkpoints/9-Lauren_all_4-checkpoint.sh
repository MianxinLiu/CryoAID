...
do
        ...
        DATA_DIRECTORY=/
        CSV_FILE_NAME=/mnt/petrelfs/yanfang/workspace/hw/yanfang/FM_GPFM/GPFM-master/dataset_csv/$task.csv
...
# srun -p smart_health_00 --gres=gpu:1 --cpus-per-task=16 --time=60:00:00 bash extract_scripts/9-Lauren_all_4.sh
