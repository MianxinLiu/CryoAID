...
do
        ...
        nohup /mnt/petrelfs/yanfang/anaconda3/envs/allslide/bin/python /mnt/petrelfs/yanfang/workspace/hw/yanfang/FM_GPFM/GPFM-master/extract_features_fp_fast.py \
...
# srun -p smart_health_00 -w SH-IDC1-10-140-1-167 --gres=gpu:1 --cpus-per-task=16 --time=60:00:00 bash extract_scripts/4-Ovary_resnet50.sh