...
import AI_FFPE_main.models as FFPEmodels
import data
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='wAtt_wLoss/Case-I', help='name of the experiment. It decides where to store samples and models')
        parser.add_argument('--easy_label', type=str, default='experiment_name', help='Interpretable name')
        parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        parser.add_argument('--checkpoints_dir', type=str, default='/ailab/user/liumianxin/transfer/FrozGanModels/', help='models are saved here')
        # model parameters
        ...
        parser.add_argument('--epoch', type=str, default='5', help='which epoch to load? set to latest to use latest cached model')
    ...
    def gather_options(self):
        ...
        model_option_setter = FFPEmodels.get_option_setter(model_name)
