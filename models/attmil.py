...
class ABMIL(nn.Module):
    def __init__(self,input_dim=768,act='relu',bias=True,dropout=True):
    ...
    def relocate(self):
        ...
        self.attention_a.to(device)
        self.attention_b.to(device)
        self.attention_c.to(device)
    ...
    def forward(self, x):
        ...
        return logits, Y_prob, Y_hat, A, 0
