...
parser.add_argument('--task', type=str, choices=['task_tumor_H3K27M', 'task_tumor_ATRX', 'task_tumor_P53',\
     'task_tumor_ATRX_neg','task_tumor_H3K27M_neg','task_tumor_P53_neg',\
         'task_tumor_H3K27M_all', 'task_tumor_ATRX_all', 'task_tumor_P53_all', 'task_3_tumor_ATRX_fujian'])
...
if args.task == 'task_tumor_H3K27M':
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/tumor_ATRX_dummy_neg.csv',
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
                            label_dict = {'neg':0, 'pos':1},
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/tumor_H3K27M_dummy_neg.csv',
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
                            label_dict = {'neg':0, 'pos':1},
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/tumor_P53_dummy_neg.csv',
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
                            label_dict = {'neg':0, 'pos':1},
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/tumor_ATRX_dummy_fujian.csv',
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
                            label_dict = {'neg':0, 'pos':1},
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/tumor_H3K27M_dummy_all.csv',
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
                            label_dict = {'neg':0, 'pos':1},
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/tumor_ATRX_dummy_all.csv',
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
                            label_dict = {'neg':0, 'pos':1},
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/tumor_P53_dummy_all.csv',
                            shuffle = False, 
                            seed = args.seed, 
                            print_info = True,
                            label_dict = {'neg':0, 'pos':1},
